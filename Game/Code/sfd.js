...
var ASKE = prompt('ENTER KEY.')
if(ASKE === 'ASKEGH4508HTO3CHV4O5O823CGT2O'){
    alert("Made by King404 2022-11-20")

    alert("In this DLC, you are the villan! Defeat heroes and rob their money to win!")
//ORDER_CODE
// 0strike.
// 1defend.
// 2arrow.
        ...
        switch (floor) {
            case 4:
                ...
                if (ask1 === '') {
                    ...
                    talk1.play()
                    alert('Ok...this hero can get pretty powerful if you let it have over than 20 turns. Put your arrows and strikes to good use.')
            ...
            case 8:
                ...
                if (ask2 === '') {
                    ...
                    talk2.play()
                    alert('..Hmm...this hero likes to attack a lot. Better prepare 30 block to defend against the fire staff.')
            ...
            case 12:
                ...
                if (ask3 === '') {
                    ...
                    talk3.play()
                    alert('This hero is very powerful...Prepare 16 block and deal 15 damage in every turn to beat this boss more easily.')
        ...
        if (enemyHp < 1) {
            ...
            switch (enemyType) {
                case '1':
                    ...
                    break;
                case '2':
                    document.getElementById("Enemy").style.backgroundImage = "url(Code/Enemy8.jpg)"
                    break;
                case '3':
            ...
            switch (floor) {
                case 4:
                    ...
                    enemyMaxHp = 217
                    enemyShield = 32
                    document.getElementById("Enemy").style.backgroundImage = "url(Code/EnemyHunter.jpg)"
                    document.getElementById("EnemyShield").innerHTML = enemyShield
                    document.getElementById("EnemyHealth").innerHTML = enemyHp + '/' + enemyMaxHp
                    alert('FACE THE WRATH OF THE HUNTER... YOU SHALL NOT PASS.')
                    break;
                ...
                case 8:
                    ...
                    document.getElementById("EnemyHealth2").style.backgroundColor = "Crimson"
                    document.getElementById("EnemyHealth2").style.backgroundImage = "None"
                    document.getElementById("Enemy").style.backgroundImage = "url(Code/EnemyReporter.jpg)"
                    document.getElementById("EnemyShield").innerHTML = enemyShield
                    document.getElementById("EnemyHealth").innerHTML = enemyHp + '/' + enemyMaxHp
                    alert('Woah, slow down! YOURE NOT GOIN ANYWHERE!')
                    break;
                case 12:
                    Occupied = true
                    hash = "/"
                    ...
                    document.getElementById("EnemyShield").innerHTML = enemyShield
                    document.getElementById("EnemyHealth").innerHTML = enemyHp + '/' + enemyMaxHp
                    alert('Well done, haha. I see that big pile o money, eh? ')
